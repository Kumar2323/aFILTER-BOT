...
PICS = (environ.get('PICS', 'https://graph.org/file/1beb7734f3f1694432c26.jpg')).split() #SAMPLE PIC
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/1beb7734f3f1694432c26.jpg')
PAYMENT_TEXT = environ.get('PAYMENT_TEXT', '<b>- ᴀᴠᴀɪʟᴀʙʟᴇ ᴘʟᴀɴs - no plans</b>')
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'oopoijjp') # owner username without @
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/naaflix_1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/naaflix_1')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/naaflix_1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'naaflix_1') # Support Chat Link Without https:// or @
